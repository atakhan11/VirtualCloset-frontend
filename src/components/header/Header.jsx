                ...
                <ul className={`${styles.navMenu} ${isMenuOpen ? styles.active : ''}`}>
                    {user ? (
                        <>
                            ...
                            <li className={styles.navItem}><NavLink to="/outfit-planner" className={({isActive}) => isActive ? styles.activeLink : styles.navLinks} onClick={closeMobileMenu}>Outfit Planner</NavLink></li>
